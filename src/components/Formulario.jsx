...
const Formulario = ({pacientes,setPacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if ([nombre, propietario, fecha, email, sintomas].includes('')) {
      console.log('Hay al emnos un campo vacio')
  ...
  return (
    <div className='md:w-1/2 lg:w-2/5'>
      ...
      <form
        ...
        <input type="submit" className='bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer transition-collors rounded-md' value={paciente.id ? 'Editar Paciente' : 'Agregar Paciente'} />
